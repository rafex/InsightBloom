 ...
 * `mvn verify` normal): asume que insightbloom-ingest esta corriendo de verdad detrás de
 * {@code infra/compose/local.yml} (puerto configurable via -Dit.ingest.baseUrl, default
 * localhost:8082).
 */
class VersionIT {

    private static final String BASE_URL = System.getProperty("it.ingest.baseUrl", "http://localhost:8082");
    ...
    void versionEndpointRespondsWithServiceName() throws Exception {
        ...
        assertEquals("insightbloom-ingest", service.asText());
    }
}
