package dev.rafex.insightbloom.moderation.it;
 ...
 * `mvn verify` normal): asume que insightbloom-moderation esta corriendo de verdad
 * detrás de {@code infra/compose/local.yml} (puerto configurable via
 * -Dit.moderation.baseUrl, default localhost:8084).
 */
class VersionIT {

    private static final String BASE_URL = System.getProperty("it.moderation.baseUrl", "http://localhost:8084");
    ...
    void versionEndpointRespondsWithServiceName() throws Exception {
        ...
        assertEquals("insightbloom-moderation", service.asText());
    }
}
