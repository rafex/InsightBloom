...
public class IntegrationConfigHandler extends BaseResourceHandler {
    ...
    public boolean get(final HttpExchange x) {
        ...
        sendOk(jx, new IntegrationConfigView(drawioBaseUrl, etherpadBaseUrl, jaasAppId, excalidrawBaseUrl));
        return true;
    }
}
