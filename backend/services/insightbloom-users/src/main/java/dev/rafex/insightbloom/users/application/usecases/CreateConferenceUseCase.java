...
public class CreateConferenceUseCase {
    ...
    public CreateResult execute(CreateRequest request) {
        validateCanvasConfig(request.canvasTool(), request.canvasAudienceMode());
        ...
        if (request.canvasTool() != null && !request.canvasTool().isBlank()) {
            conference.setCanvasTool(request.canvasTool());
        }
        if (request.canvasAudienceMode() != null && !request.canvasAudienceMode().isBlank()) {
            conference.setCanvasAudienceMode(request.canvasAudienceMode());
        }
        ...
        return new CreateResult(
            ...
            conference.getCanvasTool(), conference.getCanvasAudienceMode()
        );
    }
    ...
    private static void validateCanvasConfig(final String canvasTool, final String audienceMode) {
        if (canvasTool != null && !canvasTool.isBlank()
                && !SetCanvasConfigUseCase.DRAWIO.equals(canvasTool)
                && !SetCanvasConfigUseCase.EXCALIDRAW.equals(canvasTool)
        ...
        if (audienceMode != null && !audienceMode.isBlank()
                && !SetCanvasConfigUseCase.INDEPENDENT.equals(audienceMode)
                && !SetCanvasConfigUseCase.MODERATOR_ONLY.equals(audienceMode)) {
