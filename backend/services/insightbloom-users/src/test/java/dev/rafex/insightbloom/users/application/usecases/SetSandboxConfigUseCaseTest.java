...
class SetSandboxConfigUseCaseTest {
    ...
    void testSetValidConfig() {
        ...
        var result = useCase.execute("conf1", "python", 10, "numpy pandas", "https://github.com/user/repo", 256, null);
    ...
    void testNullPoolSizeAllowed() {
        ...
        var result = useCase.execute("conf1", "java", null, "gradle", null, null, null);
    ...
    void testJvmHeapTooSmallRejected() {
        ...
        var ex = assertThrows(IllegalArgumentException.class,
            () -> useCase.execute("conf1", "python", 1, null, null, 32, null));
    ...
    void testJvmHeapExceedsDebianContainerLimitRejected() {
        ...
        var ex = assertThrows(IllegalArgumentException.class,
            () -> useCase.execute("conf1", "python", 1, null, null, 2000, null));
    ...
    void testJvmHeapExceedsNeovimContainerLimitRejected() {
        ...
        var ex = assertThrows(IllegalArgumentException.class,
            () -> useCase.execute("conf1", "terminal-nvim", 1, null, null, 900, null));
        assertEquals("jvm_heap_exceeds_container_limit", ex.getMessage());
    }
    ...
    void testValidSeatsPerPod() {
        ...
        var result = useCase.execute("conf1", "terminal-nvim", 1, null, null, null, 6);
    ...
    void testSeatsPerPodTooLowRejected() {
        ...
        var ex = assertThrows(IllegalArgumentException.class,
            () -> useCase.execute("conf1", "terminal-nvim", 1, null, null, null, 0));
    ...
    void testSeatsPerPodTooHighRejected() {
        ...
        var ex = assertThrows(IllegalArgumentException.class,
            () -> useCase.execute("conf1", "terminal-nvim", 1, null, null, null, 11));
        assertEquals("seats_per_pod_out_of_range", ex.getMessage());
    }
}
