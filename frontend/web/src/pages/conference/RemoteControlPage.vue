...
.remote-control-page
  .remote-status
    ...
    span(v-else-if="!invalid") Conectando...

  FeedbackMessage.remote-error(
    v-if="invalid"
    message="Enlace inválido o expirado. Pide uno nuevo al organizador."
    tone="error"
  )
...
.remote-error { text-align: center; }
