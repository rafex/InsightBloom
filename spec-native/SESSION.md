...
| **Gobierno visual** | Utilidades transversales | En progreso | `.loading-text` y `.field-hint` (color, espaciado y tamaño base) viven en `global.css`; las pantallas conservan solo ajustes contextuales específicos |
