...
cp /usr/local/share/doc/insightbloom/IDE-REST-CLIENT.md "$workspace/.insightbloom/IDE-REST-CLIENT.md"
cp /usr/local/share/doc/insightbloom/IDE-APP-PUBLICATION.md "$workspace/.insightbloom/IDE-APP-PUBLICATION.md"
